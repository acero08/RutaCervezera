      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} className="flex-1" style={{ backgroundColor: "#121212" }}>
        <View className="flex-1 justify-center items-center p-5">
          ...
          <View className="items-center mb-8">
            ...
            <Text className="text-white text-3xl font-bold"> Ruta Cervecera </Text>
            <Text className="text-amber-500 text-lg mt-1">¡Descubre tu próximo brindis!</Text>
          </View>

          {/* Login Card */}
          <View className="w-full bg-gray-900 rounded-2xl p-6 shadow-lg">
            <Text className="text-white text-2xl font-bold mb-6">Inicia sesión</Text>
            ...
            <View className="flex-row justify-between items-center mb-6">
              <TouchableOpacity className="flex-row items-center" onPress={() => setRememberMe(!rememberMe)}>
                <View
                  className={`w-5 h-5 rounded mr-2 items-center justify-center ${rememberMe ? "bg-amber-600" : "border border-gray-600"}`}
                >
            ...
            {/* Login Button */}
            <TouchableOpacity onPress={() => login(email, password)} className="bg-amber-600 py-4 rounded-xl mb-5">
              <Text className="text-white font-bold text-center text-lg">Iniciar Sesión</Text>
            </TouchableOpacity>
            ...
            <View className="flex-row justify-center">
              ...
              <Link href="/userauth/Register">
                <Text className="text-amber-500 font-bold"><a href="userauth/Register"> Regístrate </a></Text>
              </Link>
            </View>
          </View>
        </View>
